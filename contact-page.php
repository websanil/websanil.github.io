<?php
	...
	$header = "Thanks for Subscription";
	if($_POST){
...
<head>
        ...
        <meta name="description" content="Jewellery Shop - Multipurpose Ecommerce Responsive Html5 template" />
        <meta name="author" content="itgeeksin.com" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
        <title>Munot Ornaments Annex</title>
        <!-- Bootstrap -->
        <!-- Favicon -->
                            ...
                            <div class="row pad-top-bottom25 head-top-sec">
                                <div class="col-md-6 col-sm-6 col-xs-12 ">
                                    <figure class="logo-box">
                                        ...
                                        <img alt=""  src="assets/img/1.png" height="90" width="90"></a>
                                    </figure>
                                </div>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="select-box">
                                        <div class="language-box2 top ">
                                            <p><a href="tel:9820364873"><i class="fa fa-phone" aria-hidden="true"></i>9820364873</a></p>
                                        </div>
										<div class="language-box2 top ">
                                            <p><a href="tel:02222404434"><i class="fa fa-phone" aria-hidden="true"></i>022 2240 4434</a></p>
                                        </div>
										<div class="language-box2 top ">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 pad-top100 pad-bottom100 heading-box">
                        ...
                        <div class="breadcrumb-box">
                            <ul class="breadcrumb">
                                <li>
                                    <a class="sab-heading-breadcrumb box-z" href="index-2.html">home</a>
                                </li>
                        ...
                        <div class="row pad-top25">
							<form action="?" method="post">
								<div class="col-md-12 col-sm-12 col-xs-12 Profile setting box">
									<p>
										<label>Name</label>
										<input type="text" name="name" class="search_terms" placeholder="" required autofocus>
									</p>
									<p>
										<label>Email Address</label>
										<input type="email" name="email" class="search_terms" placeholder="" required autofocus>
									</p>
									<p>
										<label>Phone</label>
										<input type="text" name="mobile" class="search_terms" placeholder="" required autofocus>
									</p>
									<p>
										<label>Message</label>
										<textarea name="msg" cols="10" rows="5" placeholder="" id="order_comments" class="form-controller search_terms" name="order_comments" required autofocus></textarea>
									</p>
        ...
        <footer>
            <div class="footer-main-section">
                ...
                <div class="footer-bottom-bar pad-top-bottom25">
                    <p>Copyright © 2017-2018 <span class="footer-text">Munot Ornaments Annex</span> and All Rights Reserved. Designed by  <span class="footer-text">Sanil Rodrigues & Lester Lopes</span></p>
                </div>
            </div>
        </footer>
